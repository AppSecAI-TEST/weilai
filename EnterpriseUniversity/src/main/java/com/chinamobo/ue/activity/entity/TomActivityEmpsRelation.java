...
//		this.updateTime = new Date();
	...
	private int finishedCourseTask;
	private int finishedExamTask;
	...
	public int getFinishedCourseTask() {
		return finishedCourseTask;
	}

	public void setFinishedCourseTask(int finishedCourseTask) {
		this.finishedCourseTask = finishedCourseTask;
	}

	public int getFinishedExamTask() {
		return finishedExamTask;
	}

	public void setFinishedExamTask(int finishedExamTask) {
